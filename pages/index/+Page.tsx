  ...
  <>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
      <BoxElement>
        <BoxHeadline>
          Installation
          <Icon className="text-grayDark" icon={ICON_ID.MonitorDown} />
        </BoxHeadline>
        <p>
          clone repo and: <br />
      ...
      <BoxElement>
        <BoxHeadline>
          Local Dev <Icon className="text-grayDark" icon={ICON_ID.PencilRuler} />
        </BoxHeadline>
        <p>
      ...
      <BoxElement>
        <BoxHeadline>
          Build <Icon className="text-grayDark" icon={ICON_ID.Sailboat} />
        </BoxHeadline>
        <p>
      ...
      <BoxElement>
        <BoxHeadline>
          Preview <Icon className="text-grayDark" icon={ICON_ID.PackageCheck} />
        </BoxHeadline>
        <p>
